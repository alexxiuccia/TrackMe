...
public class Keys {
    ...
    public static final UniqueKey<WorkoutRecord> WORKOUT__PK_WORKOUT = Internal.createUniqueKey(Workout.WORKOUT, DSL.name("pk_workout"), new TableField[] { Workout.WORKOUT.IDWORKOUT }, true);
}
